...
<div id="event-create-container" class="col col-md-6 offset-md-3">
    ...
    <form action="/events/update/{{$event->id}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" name="title" placeholder="Exemplo: Curso de Laravel" value="{{$event->title}}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="city" name="city" placeholder="Exemplo: São Luís - MA" value="{{$event->city}}">
        </div>
